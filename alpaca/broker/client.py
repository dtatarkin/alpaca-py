...
class BrokerClient(RESTClient):
    ...
    **Note on the `handle_pagination` param you'll see across these methods**
    ...
    def get_trade_events(self, filter: Optional[GetEventsRequest] = None, api_version: Optional[str] = None) -> Iterator:
        """
        ...
        url = self._base_url + "/" + (api_version or self._api_version) + "/events/trades"
